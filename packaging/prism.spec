...
mitmproxy_imports = [
    ...
    # All prism submodules (uvicorn loads webui_server by string)
    "prism",
    "prism.cli",
    "prism.webui_server",
    "prism.db",
    "prism.models",
    "prism.hiprofiler_client",
    "prism.device_manager",
    "prism.proxy_core",
    "prism.override_engine",
    "prism.payload_parser",
    "prism.capture",
    "prism.capture.manager",
    "prism.capture.base",
    "prism.capture.grpc_backend",
    "prism.capture.proxy_backend",
    "prism.proto",
    "prism.proto.common_types_pb2",
    "prism.proto.common_types_pb2_grpc",
    "prism.proto.profiler_service_types_pb2",
    "prism.proto.profiler_service_types_pb2_grpc",
    "prism.proto.profiler_service_pb2",
    "prism.proto.profiler_service_pb2_grpc",
    "prism.proto.plugin_service_types_pb2",
    "prism.proto.plugin_service_types_pb2_grpc",
    "prism.proto.plugin_service_pb2",
    "prism.proto.plugin_service_pb2_grpc",
    "prism.proto.network_profiler_event_pb2",
    "prism.proto.network_profiler_event_pb2_grpc",
    "prism.proto.network_profiler_config_pb2",
    "prism.proto.network_profiler_config_pb2_grpc",
]
